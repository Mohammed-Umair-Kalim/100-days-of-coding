...
// Explain & TIP: setTimeout() is a built-in JavaScript function that allows you to execute a piece of code after
//  a specified delay.
// It's especially useful for scheduling tasks, animations, or delaying execution without blocking the main thread.

// Answer 148:

let variable:string = "Hi Sir";

setTimeout(() => console.log(variable) , 5000) // shows output after 5 seconds